...
public class JiraGenerateJSON {

    JiraPropertiesInput jiraPropertiesInput = new JiraPropertiesInput();

    public String login(){
        HashMap<String, String> credentialsFromProperties = jiraPropertiesInput.readProperties();
